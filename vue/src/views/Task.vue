...
<!--      <el-button type="primary" @click="reset" style="height: 40px;margin: 0 10px 0 20px;">重置</el-button>-->
      ...
      <el-radio v-focus v-model="radioSelect" label="1" @click="showAllTask" style="margin-left: 20px">当前任务</el-radio>
    ...
    <!-- 展示未被删除或未完成的任务 -->
    <div v-show="showUnFinishedUnDeleted" style="overflow: hidden;">
    ...
    <!-- 展示完成的任务 -->
    <div v-show="showFinished" style="overflow: hidden;">
      <!-- 卡片展示区域2 展示完成的任务 -->
      <div style="margin: 30px 10px 10px 10px;width: 1020px;height: 500px;">
        <el-row :gutter="10">
...
<!--                  <el-button class="button" type="text">开始专注</el-button>-->
    ...
    <!-- 展示被删除的任务 -->
    <div v-show="showDeleted" style="overflow: hidden;">
      <!-- 卡片展示区域3 展示被删除的任务 -->
      <div style="margin: 30px 10px 10px 10px;width: 1020px;height: 500px;">
        <el-row :gutter="10">
