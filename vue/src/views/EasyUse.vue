<template>
  <div style="position: relative">
    <!-- 搜索框和任务选择框 -->
    <div v-show="isShow" style="width: 300px;height: 670px;position: relative;">
      <!-- 左上方搜索框 -->
...
<!--        <el-button style="width: 80px">搜索</el-button>-->
      ...
      <!-- 右侧日程规划(不可显示) -->
      <el-card style="width: 300px;position: absolute;left: 700px;top: 20px;">
        <div style="margin-bottom: 20px">
          {{ todayDate }} 日程规划
        </div>
        <el-descriptions border v-for="item in pickedDateTaskInfo">
          <el-descriptions-item label="名称" width="60px">{{item.tname}}</el-descriptions-item>
        </el-descriptions>
      </el-card>
    </div>
    <!-- 收起任务显示面板 -->
